...
class VendorResetPasswordView extends GetView<VendorResetPasswordController> {
  const VendorResetPasswordView({super.key});
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() => _buildPasswordField(
                      hint: '........',
                      icon: Icons.verified_user_outlined, // Shield check icon
