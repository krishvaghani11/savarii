...
class VendorNotificationsView extends GetView<VendorNotificationsController> {
  const VendorNotificationsView({super.key});
        ...
        child: Obx(() {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (type == 'ticket_booked' || type == 'booking_confirmed') {
              ...
              } else if (type == 'payout_processed' || type.contains('wallet')) {
