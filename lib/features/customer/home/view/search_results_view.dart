            ...
            children: [
              Row(
                children: [
                  ...
                  const Text(
                    '•',
                    style: TextStyle(color: AppColors.secondaryGreyBlue),
                  ),
                  const SizedBox(width: 8),
                  Text(
              ...
              ElevatedButton(
                onPressed: () => controller.bookBus(bus['name']),
                style: ElevatedButton.styleFrom(
                  backgroundColor: AppColors.primaryAccent,
                  minimumSize: const Size(0, 0), // Fixes infinity width error in Row
                  padding: const EdgeInsets.symmetric(
                    horizontal: 24,
                    vertical: 10,
                  ),
